...
png(
  filename =
    paste0("3_output/PA_by_phrase.png"),
  width =  15.25,
  height = 6.5,
  units = "cm",
  res = 300
...
png(
  filename =
    paste0("3_output/syl_norm_t_all.png"),
  width =  15.25,
  height = 20,
  units = "cm",
  res = 300
...
ggsave(filename =  paste0("3_output/Lallys_is.png"),
       plot = b,
       device = "png",
    width =  10,
    height = 6.2,
...
ggsave(filename =  paste0("3_output/peak_alignment_by_phrase.png"),
       plot = my_plot,
       device = "png",
    width =  15.25,
    height = 15.75,
