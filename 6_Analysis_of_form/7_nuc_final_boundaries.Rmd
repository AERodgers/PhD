---
title: "Chapter 06: Visual Analysis of final boundaries in A-Corpus"
...
## Checking Distribution of tokens
```{r check data}
nuc %>%
...
ggplot(
  ...
  xlim(-4, 4) +
 ylim(0, 0.4) +
  labs(title = "Density and Dotplot of Boundary f0 Scaling in A- and H-Corpora")
```
