...
#pn_l_t_mdl <- optimizeModel(pn_l_t_mdl, reject_nl = T, verbose = F)
...
pn_l_t_mdl.trimmed <- optimizeModel(pn_l_t_mdl.trimmed, reject_nl = T, verbose = F)
...
getModelFixedFX(pn_l_t_mdl.trimmed, write="4_pn_output/pn_l_t")$slopes
```
...
pn_l_f0_mdl <- optimizeModel(pn_l_f0_mdl, reject_nl = T, verbose = F)
x <- summariseLME(pn_l_f0_mdl, print_summary = F, plot_resids = F, run_step = F)
...
getModelFixedFX(pn_l_f0_mdl, write = "4_pn_output/pn_l_f0")$slopes
```
...
pn_h_t_mdl <- optimizeModel(pn_h_t_mdl, reject_nl = T)
...
#pn_h_t_mdl.trimmed <- optimizeModel(pn_h_t_mdl.trimmed, reject_nl = T, verbose = F)
...
```
```{r plot h_t estimated effects, fig.height=1.5, fig.width=4}
...
getModelFixedFX(pn_h_t_mdl.trimmed, write="4_pn_output/pn_h_t")$slopes
```
...
pn_h_f0_mdl <- optimizeModel(pn_h_f0_mdl, reject_nl = T, verbose = F)
...
getModelFixedFX(pn_h_f0_mdl, write="4_pn_output/pn_h_f0")$slopes
```
...
pn_f0_exc_mdl <- optimizeModel(pn_f0_exc_mdl, reject_nl = T, verbose = F)
...
getModelFixedFX(pn_f0_exc_mdl.trimmed)$slopes
```
...
x <- summariseLME(pn_lh_slope_mdl,
                  print_summary = F,
                  run_step = T,
                  plot_resids = T)
...
getModelFixedFX(pn_lh_slope_mdl.trimmed,
                write = "4_pn_output/pn_lh_slope")$slopes
```
