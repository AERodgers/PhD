...
nuc_lh_slope_mdl <- optimizeModel(nuc_lh_slope_mdl, verbose = T, reject_nm = T)
...
### H time proportional to duration of voicing and duration of foot
...
nuc_data <- nuc_data %>%
  mutate(nuc_h_t_re_v_dur = h_t  / e_t)
...
nuc_data <- nuc_data %>%
  mutate(h_t_re_ft_dur = h_t  / (foot_end_t - v_onset_t))
