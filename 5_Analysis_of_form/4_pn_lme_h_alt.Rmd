...
pn_h_t_alt_mdl <-
  optimizeModel(pn_h_t_alt_mdl, reject_nl = T, verbose = F)
...
pn_h_t_alt_mdl.trimmed <-
  optimizeModel(pn_h_t_alt_mdl.trimmed, reject_nl = T, verbose = F)
...
getModelFixedFX(pn_h_t_alt_mdl.trimmed)$slopes
```
...
pn_h_f0_alt_mdl <-
  optimizeModel(pn_h_f0_alt_mdl, reject_nl = T, verbose = F)
