...
pn_l_t_mdl <- optLme4Mdl(pn_l_t_mdl, reject_nl = T)
x <- summariseLME(pn_l_t_mdl, run_step = T, print_summary = F)
...
pn_l_t_mdl.trimmed <- update(pn_l_t_mdl, data = pn_l_t_data.trimmed)
pn_l_t_mdl.trimmed <- optLme4Mdl(pn_l_t_mdl.trimmed, reject_nl = T)

pn_l_t_mdl.trimmed <- update(pn_l_t_mdl.trimmed,
                             control = lmerControl(
                               optimizer = "nloptwrap",
                               optCtrl = list(
...
read_csv("6_4_pn_all_output/pn_l_t_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_l_t_b1.csv") %>%
  tidyStatNumbers() %>%
...
pn_l_f0_mdl <- optLme4Mdl(pn_l_f0_mdl, reject_nl = T)
x <- summariseLME(pn_l_f0_mdl, print_summary = F, draw_resids = F)
...
pn_l_f0_mdl <- optLme4Mdl(pn_l_f0_mdl, reject_nl = T)
x <- summariseLME(pn_l_f0_mdl, print_summary = F)
...
pn_l_f0_mdl.tidy <- analyseModel(pn_l_f0_mdl,
...
read_csv("6_4_pn_all_output/pn_l_f0_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_l_f0_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model"))
...
#pn_h_t_mdl.trimmed <- optLme4Mdl(pn_h_t_mdl.trimmed, reject_nl = T)
...
read_csv("6_4_pn_all_output/pn_h_t_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_h_t_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model"))
...
pn_h_f0_mdl <- optLme4Mdl(pn_h_f0_mdl, reject_nl = T)
...
read_csv("6_4_pn_all_output/pn_h_f0_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_h_f0_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model"))
...
pn_f0_exc_mdl <- optLme4Mdl(pn_f0_exc_mdl, reject_nl = T)
...
pn_f0_exc_mdl.trimmed <- optLme4Mdl(pn_f0_exc_mdl.trimmed, reject_nl = T)

x <- summariseLME(pn_f0_exc_mdl.trimmed,
             run_step = F,
             write = "6_4_pn_all_output/pn_f0_exc_anova.csv")

pn_f0_exc_mdl.trimmed = optLme4Mdl(pn_f0_exc_mdl.trimmed)
...
read_csv("6_4_pn_all_output/pn_f0_exc_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_f0_exc_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model"))
...
#pn_lh_slope_mdl.trimmed <- optLme4Mdl(pn_lh_slope_mdl.trimmed, reject_nl = T)
...
read_csv("6_4_pn_all_output/pn_lh_slope_b0.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("Intercepts of model"))

read_csv("6_4_pn_all_output/pn_lh_slope_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model"))
