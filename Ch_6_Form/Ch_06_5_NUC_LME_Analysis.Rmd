...
nuc_stress <- read_csv("data/stressed_syls.csv", col_types =)
...
nuc_data <- nuc %>%
  ...
  mutate(
    str_syl = stim,
    str_syl = str_replace(str_syl, nuc_stress$stim[1], nuc_stress$nuc_syl[1]),
    str_syl = str_replace(str_syl, nuc_stress$stim[2], nuc_stress$nuc_syl[2]),
    str_syl = str_replace(str_syl, nuc_stress$stim[3], nuc_stress$nuc_syl[3]),
    str_syl = str_replace(str_syl, nuc_stress$stim[4], nuc_stress$nuc_syl[4]),
    str_syl = str_replace(str_syl, nuc_stress$stim[5], nuc_stress$nuc_syl[5]),
    str_syl = str_replace(str_syl, nuc_stress$stim[6], nuc_stress$nuc_syl[6]),
    str_syl = str_replace(str_syl, nuc_stress$stim[7], nuc_stress$nuc_syl[7]),
    str_syl = str_replace(str_syl, nuc_stress$stim[8], nuc_stress$nuc_syl[8]),
    str_syl = str_replace(str_syl, nuc_stress$stim[9], nuc_stress$nuc_syl[9]),
    str_syl = str_replace(str_syl, nuc_stress$stim[10], nuc_stress$nuc_syl[10]),
    str_syl = str_replace(str_syl, nuc_stress$stim[11], nuc_stress$nuc_syl[11]),
    str_syl = str_replace(str_syl, nuc_stress$stim[12], nuc_stress$nuc_syl[12]),
    str_syl = str_replace(str_syl, nuc_stress$stim[13], nuc_stress$nuc_syl[13]),
    str_syl = str_replace(str_syl, nuc_stress$stim[14], nuc_stress$nuc_syl[14]),
    str_syl = str_replace(str_syl, nuc_stress$stim[15], nuc_stress$nuc_syl[15]),
...
- initial run, step() found: `l_t ~ pre_syls + gender + (1 | speaker) + (1 | str_syl)`
- 
```{r set l_t equation}
...
- removed  speech_rate and str_syl random effects to eliminate singularity in getModelFixedFX()
...
- Only intercepts only model avoided convergence and singularity issues
- step() suggests: `h_t ~ foot_syls + pre_syls + fin_phon + nuc_new_word + gender + (1 | speaker) + (1 | str_syl)`
...
-  `e_t ~ foot_syls + pre_syls + fin_phon + nuc_new_word + gender + (1 | speaker) + (1 | str_syl) + (1 | foot_dur) + (1 | nuc_pre_text) `

- rerunning without `(1 | speech_rate)`, it suggests:
`e_t ~ foot_syls + pre_syls + gender + (1 | speaker) + (1 | str_syl) + (1 | foot_dur)`
...
- model words once random intercepts of speech_rate and str_syl are removed
...
- model works after removing random intercepts of speech_rate, str_syl, and foot_dur.
### LH Excursion
