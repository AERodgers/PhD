...
- We know that gender has an effect (though also of speaker). Unfortunately, inclusion of gender causes a convergence error, so it is removed, and re by speaker are plotted.
```{r set isLH equation}
