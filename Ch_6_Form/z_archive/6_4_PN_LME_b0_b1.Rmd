...
summariseLME(pn_l_t_mdl.trimmed
             ,run_step = TRUE
             ,write = "6_4_subset_output/pn_l_t_anova.csv"
             )
```
...
pn_l_t_mdl.tidy <- analyseModel(
  pn_l_t_mdl.trimmed,
  write="6_4_subset_output/pn_l_t",
  type = "pred",
  factor_matrix = TRUE
  )
...
summariseLME(pn_l_f0_mdl.trimmed
             , run_step = TRUE
             , write = "6_4_subset_output/pn_l_f0_anova.csv"
             )
```
...
pn_l_f0_mdl.tidy <- analyseModel(
  pn_l_f0_mdl.trimmed
  , write="6_4_subset_output/pn_l_f0"
  , type = "pred"
  )
...
summariseLME(
  pn_h_t_mdl.trimmed
  , run_step = TRUE
  , write = "6_4_subset_output/pn_h_t_anova.csv"
  )
```
...
pn_h_t_mdl.tidy <- analyseModel(
  pn_h_t_mdl.trimmed
  , write="6_4_subset_output/pn_h_t"
  , type = "pred"
  , factor_matrix = TRUE
  )
...
h_t_orig_equation = formula(
  ...
  + wrd_end_syl
  + gender
  + (1 + ana_syls + wrd_end_syl | speaker)
  )
