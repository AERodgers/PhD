...
write_tsv(pn_foot_summary, "../6_1_output/pn_foot_count_actual.txt")
...
Output and Figures
```{r}
write_tsv(pn_foot_GDH_summary, "../6_1_output/pn_foot_count_GDH.txt")
...
write_tsv(pn_foot_isGLH_summary, "../6_1_output/pn_foot_count_isGLH.txt")
