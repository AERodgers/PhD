...
i = 1
  ...
  fileName = paste("PN_anac_modelOutput/1_PN.anac.model.L_t_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.L_t,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/1_PN.L_t.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.L_t,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/1_PN.L_t.regression.plot_", syls[i], ".png", sep = ""),
  ...
  fileName = paste("PN_anac_modelOutput/2_PN.anac.model.H_t_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.H_t,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/2_PN.H_t.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.H_t,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/2_PN.H_t.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_anac_modelOutput/3_PN.anac.model.L_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.L_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/3_PN.L_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.L_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/3_PN.L_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")


  PN.anac.model.H_fo.sum = summary(PN.anac.model.H_fo)
  PN.anac.model.H_fo.ano = anova(PN.anac.model.H_fo)
  fileName = paste("PN_anac_modelOutput/4_PN.anac.model.H_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.H_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/4_PN.H_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.H_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/4_PN.H_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_anac_modelOutput/5_PN.anac.model.med_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.med,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/5_PN.med.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.med,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/5_PN.med.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")


  PN.anac.model.mean.sum = summary(PN.anac.model.mean)
  PN.anac.model.mean.ano = anova(PN.anac.model.mean)
  fileName = paste("PN_anac_modelOutput/6_PN.anac.model.mean_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.mean,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/6_PN.mean.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.mean,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/6_PN.mean.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")


  PN.anac.model.slope.sum = summary(PN.anac.model.slope)
  PN.anac.model.slope.ano = anova(PN.anac.model.slope)
  fileName = paste("PN_anac_modelOutput/7_PN.anac.model.slope_", syls[i], "syl.txt", sep = "")
  capture.output(PN.anac.model.slope.sum, file = fileName)
  capture.output(PN.anac.model.slope.ano, file = fileName, append =  TRUE)

  tab_model(PN.anac.model.slope,
            title = paste("Slope (ST/sec),", syls[i], "as intercept"),
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/7_PN.slope.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.slope,
             title = paste("Slope (ST/sec),", syls[i], "as intercept"),
             show.intercept = FALSE,
             show.values = TRUE,
             #order.terms = c(2,3,4),
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/7_PN.slope.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_anac_modelOutput/7_PN.anac.model.R_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.anac.model.R_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_anac_modelOutput/8_PN.R_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.anac.model.R_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_anac_modelOutput/8_PN.R_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
