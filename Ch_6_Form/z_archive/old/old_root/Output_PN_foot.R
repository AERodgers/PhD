...
i = 4
  ...
  fileName = paste("PN_foot_modelOutput/1_PN.ft.model.L_t_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.L_t,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/1_PN.L_t.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.L_t,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/1_PN.L_t.regression.plot_", syls[i], ".png", sep = ""),
  ...
  fileName = paste("PN_foot_modelOutput/2_PN.ft.model.H_t_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.H_t,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/2_PN.H_t.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.H_t,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/2_PN.H_t.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_foot_modelOutput/3_PN.ft.model.L_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.L_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/3_PN.L_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.L_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/3_PN.L_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  
  
  PN.ft.model.H_fo.sum = summary(PN.ft.model.H_fo)
  PN.ft.model.H_fo.ano = anova(PN.ft.model.H_fo)
  fileName = paste("PN_foot_modelOutput/4_PN.ft.model.H_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.H_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/4_PN.H_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.H_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/4_PN.H_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_foot_modelOutput/5_PN.ft.model.med_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.med,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/5_PN.med.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.med,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/5_PN.med.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  
  
  PN.ft.model.mean.sum = summary(PN.ft.model.mean)
  PN.ft.model.mean.ano = anova(PN.ft.model.mean)
  fileName = paste("PN_foot_modelOutput/6_PN.ft.model.mean_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.mean,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/6_PN.mean.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.mean,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/6_PN.mean.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_foot_modelOutput/8_PN.ft.model.R_fo_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.R_fo,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/8_PN.R_fo.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.R_fo,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/8_PN.R_fo.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
  ...
  fileName = paste("PN_foot_modelOutput/9_PN.ft.model.D_t_", syls[i], "syl.txt", sep = "")
  ...
  tab_model(PN.ft.model.D_t,
            ...
            show.icc = FALSE,
            file = paste("PN_foot_modelOutput/9_PN.D_t.regression_", syls[i], "syl.html", sep = ""))
  plot_model(PN.ft.model.D_t,
             ...
             vline.color = "red",
             colors = "Black")
  ggsave(file = paste("PN_foot_modelOutput/9_PN.D_t.regression.plot_", syls[i], ".png", sep = ""),
         width = 15, height = 8, units = "cm")
