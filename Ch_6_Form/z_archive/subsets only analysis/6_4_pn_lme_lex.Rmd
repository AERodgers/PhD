...
anova <- summariseLME(
  pn_lex_h_t_mdl,
  run_step = F
  , write = "6_4_pn_subs_output/pn_lex_h_t_anova.csv"
  )
...
read_csv("6_4_pn_subs_output/pn_lex_h_t_anova.csv") %>%
  tidyStatNumbers() %>%
...
pn_lex_h_t_mdl.tidy <- analyseModel(
  pn_lex_h_t_mdl
  , write="6_4_pn_subs_output/pn_lex_h_t"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_lex_h_t pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_lex_h_t_mdl, write="6_4_pn_subs_output/pn_lex_h_t")
...
read_csv("6_4_pn_subs_output/pn_lex_h_t_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_lex_h_t_mdl)))

read_csv("6_4_pn_subs_output/pn_lex_h_t_b1.csv") %>%
  tidyStatNumbers() %>%
...
anova <- summariseLME(
  pn_lex_h_f0_mdl
 , write = "6_4_pn_subs_output/pn_lex_h_f0_anova.csv"
  )
...
read_csv("6_4_pn_subs_output/pn_lex_h_f0_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_lex_h_f0_mdl.tidy <- analyseModel(
  pn_lex_h_f0_mdl
  , write="6_4_pn_subs_output/pn_lex_h_f0"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_lex_h_f0 pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_lex_h_f0_mdl, write="6_4_pn_subs_output/pn_lex_h_f0")

adjustP_posthoc("6_4_pn_subs_output/", p.value, suffix_id = "_b0", marginal = T)
adjustP_posthoc("6_4_pn_subs_output/", p.value, suffix_id = "_b1", marginal = T)

read_csv("6_4_pn_subs_output/pn_lex_h_f0_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_lex_h_f0_mdl)))

read_csv("6_4_pn_subs_output/pn_lex_h_f0_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_lex_h_f0_mdl)))
...
anova <- summariseLME(
  ...
  run_step = F
  , write = "6_4_pn_subs_output/pn_lex_f0_exc_anova.csv"
  )
...
read_csv("6_4_pn_subs_output/pn_lex_f0_exc_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_lex_f0_exc_mdl.tidy <- analyseModel(
  pn_lex_f0_exc_mdl.trimmed
  , write="6_4_pn_subs_output/pn_lex_f0_exc"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
...
read_csv("6_4_pn_subs_output/pn_lex_f0_exc_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_lex_f0_exc_mdl.trimmed)))

read_csv("6_4_pn_subs_output/pn_lex_f0_exc_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_lex_f0_exc_mdl.trimmed)))
```
...
tibble(`Summary of model` = getModelFormula(pn_lex_lh_slope_mdl)) %>%
        formattable(align = "l")

anova <- summariseLME(pn_lex_lh_slope_mdl,
                      write ="6_4_pn_subs_output/pn_lex_lh_slope_anova.csv")

adjustP_posthoc("6_4_pn_subs_output/",
                p.value,
                suffix_id = "_anova")

read_csv("6_4_pn_subs_output/pn_lex_lh_slope_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
                            getModelFormula(pn_lex_lh_slope_mdl)))
...
pn_lex_lh_slope_mdl.tidy <- analyseModel(
  pn_lex_lh_slope_mdl
  , write="6_4_pn_subs_output/pn_lex_lh_slope"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_lex_lh_slope pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_lex_lh_slope_mdl, write="6_4_pn_subs_output/pn_lex_lh_slope")


adjustP_posthoc("6_4_pn_subs_output/", p.value, suffix_id = "_b0", marginal = T)
adjustP_posthoc("6_4_pn_subs_output/", p.value, suffix_id = "_b1", marginal = T)

read_csv("6_4_pn_subs_output/pn_lex_lh_slope_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_lex_lh_slope_mdl)))

read_csv("6_4_pn_subs_output/pn_lex_lh_slope_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_lex_lh_slope_mdl)))
