...
pn_foot_summary_raw <- pn_foot %>%
  ...
  write_csv("6_1_output/pn_foot_unbalanced.csv")
...
pn_ana_summary_raw <- pn_ana %>%
  ...
  write_csv("6_1_output/pn_ana_unbalanced.csv")
...
nuc_foot_summary_raw <- nuc_foot %>%
  ...
  write_csv("6_1_output/nuc_foot_unbalanced.csv")
...
```{r warning=TRUE, fig.width = 8, fig.height = 4}
