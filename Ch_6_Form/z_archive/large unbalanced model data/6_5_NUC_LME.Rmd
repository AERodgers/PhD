...
- step() suggests: `l_f0 ~ foot_syls + (1 | speaker) + (1 | nuc_pre_text)`
...
step() suggests: `h_f0 ~ foot_syls + fin_phon + (1 | speaker) + (1 | nuc_pre_text)`
This is very odd. So, removing (1 | nuc_pre_text)!!
...
initial step() suggests:
 ...
 `e_t ~ foot_syls + pre_syls + gender + (1 | speaker) + (1 | nuc_str_syl)`
...
initial step() suggested: `e_f0 ~ foot_syls + fin_phon + (1 | speaker) + (1 | nuc_pre_text)`
