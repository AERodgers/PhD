...
```{r l_t model summary, ffig.height=2.5, fig.width=2.823, results="asis"}
...
getModelFixedFX(nuc_l_t_mdl, write="6_5_nuc_all_output/nuc_l_t")$slopes
```
...
getModelFixedFX(nuc_l_f0_mdl.trimmed,
                write = "6_5_nuc_all_output/nuc_l_f0")$slopes
...
getModelFixedFX(nuc_h_t_mdl,
                write = "6_5_nuc_all_output/nuc_h_t")$slopes
```
...
getModelFixedFX(nuc_h_f0_mdl.trimmed,
                          write = "6_5_nuc_all_output/nuc_h_f0")$slopes
...
```{r e_t model summary, fig.height=2.5, fig.width=2.823, include = F, results="asis"}
...
getModelFixedFX(nuc_e_f0_mdl.trimmed,
                write="6_5_nuc_all_output/nuc_e_f0")$slopes
```
...
```{r f0_exc model summary, ffig.height=2.5, fig.width=2.823, results="asis"}
...
nuc_lh_slope_mdl.trimmed <- optLme4Mdl(nuc_lh_slope_mdl.trimmed)
...
```{r do lh_slope pairwise analysis}
