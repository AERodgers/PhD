...
anova <- summariseLME(pn_foot_l_t_mdl.trimmed, 
                      write = "6_4_output/pn_foot_l_t_anova.csv")

adjustP_posthoc("6_4_output/",
                p.value,
                suffix_id = "_anova")

read_csv("6_4_output/pn_foot_l_t_anova.csv") %>%
  tidyStatNumbers() %>%
...
read_csv("6_4_output/pn_foot_l_t_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_l_t_mdl.trimmed)))

read_csv("6_4_output/pn_foot_l_t_b1.csv") %>%
  tidyStatNumbers() %>%
...
anova <- summariseLME(
 ...
 , write = "6_4_output/pn_foot_l_f0_anova.csv"
  )
...
read_csv("6_4_output/pn_foot_l_f0_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_foot_l_f0_mdl.tidy <- analyseModel(
  pn_foot_l_f0_mdl.trimmed
  , write="6_4_output/pn_foot_l_f0"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_foot_l_f0 pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_foot_l_f0_mdl.trimmed, write="6_4_output/pn_foot_l_f0")

adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b0")
adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b1")

read_csv("6_4_output/pn_foot_l_f0_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_l_f0_mdl.trimmed)))

read_csv("6_4_output/pn_foot_l_f0_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_foot_l_f0_mdl.trimmed)))
```
...
anova <- summariseLME(
 ...
 , write = "6_4_output/pn_foot_h_t_anova.csv"
  )
...
read_csv("6_4_output/pn_foot_h_t_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
charts <- getModelFixedFX(pn_foot_h_t_mdl.trimmed, write="6_4_output/pn_foot_h_t")

adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b0")
adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b1")

read_csv("6_4_output/pn_foot_h_t_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_h_t_mdl.trimmed)))

read_csv("6_4_output/pn_foot_h_t_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_foot_h_t_mdl.trimmed)))
...
anova <- summariseLME(
  pn_foot_h_f0_mdl
 , write = "6_4_output/pn_foot_h_f0_anova.csv"
  )
...
read_csv("6_4_output/pn_foot_h_f0_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_foot_h_f0_mdl.tidy <- analyseModel(
  pn_foot_h_f0_mdl
  , write="6_4_output/pn_foot_h_f0"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_foot_h_f0 pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_foot_h_f0_mdl, write="6_4_output/pn_foot_h_f0")

adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b0")
adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b1")

read_csv("6_4_output/pn_foot_h_f0_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_h_f0_mdl)))

read_csv("6_4_output/pn_foot_h_f0_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_foot_h_f0_mdl)))
...
anova <- summariseLME(
  pn_foot_f0_exc_mdl,
  run_step = F
  , write = "6_4_output/pn_foot_f0_exc_anova.csv"
  )
...
read_csv("6_4_output/pn_foot_f0_exc_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_foot_f0_exc_mdl.tidy <- analyseModel(
  pn_foot_f0_exc_mdl
  , write="6_4_output/pn_foot_f0_exc"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_foot_f0_exc pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_foot_f0_exc_mdl, write="6_4_output/pn_foot_f0_exc")
```
...
```{r}
read_csv("6_4_output/pn_foot_f0_exc_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_f0_exc_mdl)))
```
...
```{r}
read_csv("6_4_output/pn_foot_f0_exc_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_foot_f0_exc_mdl)))
...
anova <- summariseLME(pn_foot_lh_slope_mdl.trimmed,
                      write ="6_4_output/pn_foot_lh_slope_anova.csv")

adjustP_posthoc("6_4_output/",
                p.value,
                suffix_id = "_anova")

read_csv("6_4_output/pn_foot_lh_slope_anova.csv") %>%
  tidyStatNumbers() %>%
  formattable(caption = paste("ANOVA of model:",
...
pn_foot_lh_slope_mdl.tidy <- analyseModel(
  ...
  , write="6_4_output/pn_foot_lh_slope"
  , type = "pred"
  , factor_matrix = TRUE
  )
```
```{r pn_foot_lh_slope pairwise comparison, fig.height=2.5, fig.width=3.01}
charts <- getModelFixedFX(pn_foot_lh_slope_mdl.trimmed, write="6_4_output/pn_foot_lh_slope")


adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b0")
adjustP_posthoc("6_4_output/", p.value, suffix_id = "_b1")

read_csv("6_4_output/pn_foot_lh_slope_b0.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Intercepts of model:",
                            getModelFormula(pn_foot_lh_slope_mdl.trimmed)))

read_csv("6_4_output/pn_foot_lh_slope_b1.csv") %>%
  tidyStatNumbers() %>%
formattable(caption = paste("Slopes of model:",
                            getModelFormula(pn_foot_lh_slope_mdl.trimmed)))
