...
### Anova comparison of current model with model with null fixed factors.
```{r echo=FALSE, warning=FALSE, fig.width=15.5/2.54, fig.height=15.5/16*9/2.54}
anova(cur_model, null_model, test="Chisq")
```

```{r echo=FALSE, warning=FALSE, fig.width=7.5/2.54, fig.height=15.5/16*9/2.54}
kable(r.squaredGLMM(cur_model), caption = "Theoretical marginal and conditional r^2 of model.")
