...
pn_stress <- read_csv("data/stressed_syls.csv", col_types =)
...
pn <- pn %>%
  ...
  mutate(
    str_syl = stim,
    str_syl = str_replace(str_syl, pn_stress$stim[1], pn_stress$pn_syl[1]),
    str_syl = str_replace(str_syl, pn_stress$stim[2], pn_stress$pn_syl[2]),
    str_syl = str_replace(str_syl, pn_stress$stim[3], pn_stress$pn_syl[3]),
    str_syl = str_replace(str_syl, pn_stress$stim[4], pn_stress$pn_syl[4]),
    str_syl = str_replace(str_syl, pn_stress$stim[5], pn_stress$pn_syl[5]),
    str_syl = str_replace(str_syl, pn_stress$stim[6], pn_stress$pn_syl[6]),
    str_syl = str_replace(str_syl, pn_stress$stim[7], pn_stress$pn_syl[7]),
    str_syl = str_replace(str_syl, pn_stress$stim[8], pn_stress$pn_syl[8]),
    str_syl = str_replace(str_syl, pn_stress$stim[9], pn_stress$pn_syl[9]),
    str_syl = str_replace(str_syl, pn_stress$stim[10], pn_stress$pn_syl[10]),
    str_syl = str_replace(str_syl, pn_stress$stim[11], pn_stress$pn_syl[11]),
    str_syl = str_replace(str_syl, pn_stress$stim[12], pn_stress$pn_syl[12]),
    str_syl = str_replace(str_syl, pn_stress$stim[13], pn_stress$pn_syl[13]),
    str_syl = str_replace(str_syl, pn_stress$stim[14], pn_stress$pn_syl[14]),
    str_syl = str_replace(str_syl, pn_stress$stim[15], pn_stress$pn_syl[15]),
    str_syl = factor(str_syl, levels = unique(str_syl))
  ) %>%
  select (-stim)
...
- Convergence issues. Removing re as per step(): speech_rate, foot_dur, str_syl
...
- first run: step() suggests: `ana_syls + foot_syls + (1 | speaker) + (1 | str_syl)`
...
-  first run, step() suggests: `f0_exc ~ foot_syls + ana_syls + (1 | speaker) + (1 | str_syl)`
