...
# run model
h_t_model <-
  lmer(h_t ~ mode + fin_phon + gender + (1 | speaker) + (1 | prompt),
       data = m_corpus,
        control = lmerControl(
          optimizer = "optimx",
          calc.derivs = FALSE,
...
charts <- getModelFixedFX(
  my_equation = h_t ~ mode + fin_phon + gender + (1 | speaker) + (1 | prompt),
  my_data = m_corpus,
  write="../output/acc_phon_h_t"
)
charts$intercepts
charts$slopes
