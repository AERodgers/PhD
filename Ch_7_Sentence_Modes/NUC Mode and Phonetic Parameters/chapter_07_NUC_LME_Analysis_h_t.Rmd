...
for (i in 1:(num_levels)) {
  ...
  cur_modeh_tidy <- filter(cur_modeh_tidy, term %in% keep)
  
  # add remaining pairwise comparisons to main tibble.
  all_models_tidy <- bind_rows(all_models_tidy, cur_modeh_tidy)
