---
title: "Chapter 7 - LME analysis of Mode and Nuclear Contours: slope"
...
cur_equation <- "slope ~ mode + gender + (1 + mode | speaker)"
...
do.call(rbind, r2_nakagawa(temp_mdl))[,1] %>% 
  write.csv("output/LME_slope_r2.csv")
...
filter(all_models_tidy, pairwise == "intercept") %>%
  ...
  write_csv("output/LME_slope_b0.csv")
...
filter(all_models_tidy, pairwise %notin% c("intercept", "N/A")) %>%
  ...
  write_csv("output/LME_slope_b1.csv")
