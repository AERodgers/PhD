...
m_corpus %>%
  ...
  formattable(
    caption = paste(
      "Utterance level intonational phonology without Register Tier in M-corpus ",
...
```{r plot adjusted distrubition of contours by mode and gender, fig.height=3.5, fig.width=6.1, results="asis"}
ggplot(
  ...
  ggtitle("Nuclear contours by sentence mode and gender (adjusted, no register tierexcluding H* and >H*)") +
...
```{r plot adjusted distrubition of contours by mode, fig.height=2.2, fig.width=6, results="asis"}
ggplot(
  nuc_contour_by_mode_adj %>%
    # Uncount table for bar chart.
...
#### GLMM test of nuc_contour as a fn of mode.
...
```{r GLMM Test of nuc_contour as a fn of mode}
...
```{r nuc_contour GLMM Figures and Charts, fig.width = 4.2, fig.height = 2.5, results="asis"}
cat(
...
x <- printTidyModel(nuc_contour_model,
                    write_r2="Mode_nuc_contour_No_Reg",
                    is_GLM = TRUE,
                    transform="exp",
                    show.intercept=TRUE,
                    type="pred"
