...
```{r GLMM of 0 and H re mode Figures and Charts, fig.width =3.57, fig.height = 2.78, results="asis"}
cat(
...
```{r extra chart Charts, fig.width =3.7, fig.height = 3.7}
ggpredict(fin_phon_model_H_or_not, terms=c("mode")) %>%
  plot() +
  labs(caption = "", title = "") +
  ylim(0,1) +
  ylab("probability of H%") +
   geom_text(aes(
