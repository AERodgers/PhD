...
```{r warning=TRUE, fig.width = 5, fig.height = 2.5}
...
```{r, fig.width = 14, fig.height=5, results="asis"}
...
```{r fig.width = 14, fig.height = 3, results="asis"}
...
```{r GLMM Test Results, fig.width = 4.2, fig.height = 2.5, results="asis"}
cat(
