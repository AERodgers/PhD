...
subtitle: 'Sentence Mode and Nuclear Phonology, Register Tier'
...
```{r h_reg_model test results, fig.width = 4.2, fig.height = 2.5, results="asis"}
cat(
...
```{r one_pa_model test results, fig.width = 4.5, fig.height = 2.5, results="asis"}
cat(
...
tidy_summary <- analyseModel(one_pa_or_h_reg_model,
