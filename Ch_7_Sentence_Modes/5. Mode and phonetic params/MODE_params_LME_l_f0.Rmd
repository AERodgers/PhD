...
-   Using same model as for h_f0, i.e., intercepts-only without (1|promt)

#### `l_f0 ~ mode + fin_phon + gender + (1 | speaker)`

```{r run trimmed models,  fig.height=3, fig.width=9, include=FALSE, tidy = TRUE}
...
summarise_lme(l_f0_model.trimmed, run_step = TRUE,
...
l_f0_model_trimmed.tidy <- printTidyModel(l_f0_model.trimmed,
