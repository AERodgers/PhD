...
cur_equation <-
  "slope ~ mode + gender + (1 + mode | speaker) + (1 | prompt)"
...
# set current equation
cur_equation <-
  "slope ~ mode + gender + (1 + mode | speaker)"
...
removed %>% 
  select(c(speaker, gender, mode, prompt, phr_phon, slope, slope_z)) %>% 
