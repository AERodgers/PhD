...
cur_equation <- "h_t ~ mode + gender + (1 + mode | speaker)"
...
tidy(temp_mdl) %>%
  ...
  formattable(caption = "Intercept and slopes of fixed effects",
...
do.call(rbind, r2_nakagawa(temp_mdl))[,1]  %>% write.csv("output/LME_h_t_r2.csv")
