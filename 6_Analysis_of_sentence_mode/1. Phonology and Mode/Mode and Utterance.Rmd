...
## Utterance-wide Intonational Phonology {.tabset}
...
## Nuclear PA-only IPs and High Register in Nuclear PA {.tabset}
...
# BGLMM analysis of utterance wide events, high register, and sentence mode

## Model for Nuclear PA only  {.tabset}
...
nuc_pa_only_model <- bglmer(
  `nuclear PA only` ~ mode + gender + (1 + mode | speaker) + (1 | prompt),
  data = m_corpus,
...
## Model for Nuclear-PA IP only OR high register in nuclear PA {.tabset}
